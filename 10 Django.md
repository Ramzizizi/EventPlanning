...
- прописатьпуть к папке с стаитческими данными в setting.py
...
- Form class
- класс для инициализирования формы, её полей и других данныx


- как использовать форму в View, Template?
- в ответе на запросы необходимо возваращать форму в контексте, а в шаблоне необходимо прописать офрму 
...
- необходимо переписапть функцию "save_formset"
